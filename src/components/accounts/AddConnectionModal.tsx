...
export const AddConnectionModal: React.FC<{ isOpen: boolean; onClose: () => void }> = ({ isOpen, onClose }) => {
  ...
  const { setConnections } = useAccounts();
  ...
  const handleSaveConnection = () => {
    const newConn = {
      ...
      capabilities: ['TEXT', 'IMAGE', 'VIDEO', 'AUDIO'] as any,
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
      ...
      >
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm text-smash-text-secondary max-w-sm">Verifying capabilities for {providerName}. Please wait.</p>
                </div>
              </motion.div>
            )}
             ...
             {step === 4 && (
              ...
              >
                ...
                <div className="flex flex-col gap-2 items-center">
                  ...
                  <p className="text-sm text-smash-text-secondary max-w-sm"><strong className="text-white">{connectionName}</strong> has been added to your workspace and is ready to use.</p>
        ...
        <div className="px-8 py-5 border-t border-white/5 flex justify-between items-center glass-2 shrink-0">
          ...
          {step < 3 && (
            <Button variant="primary" disabled={!selectedType && step === 1} onClick={() => setStep(step + 1)}>
